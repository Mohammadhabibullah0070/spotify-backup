...
function HomePage() {
  ...
  const sameAccount =
    source?.user && destination?.user && source.user.id === destination.user.id;
    ...
    <AppLayout>
      <section className="hero">
        ...
        <p className="hero__tagline">
          Back up your Spotify playlists, liked songs, and library — then
          restore them to any account. Simple, private, no server needed.
        </p>
      ...
      <section className="steps">
        <div className="step">
          ...
          <p className="step__text">
            Connect <strong>Source</strong> → click <strong>Backup</strong>
          </p>
        </div>
        ...
        <div className="step">
          ...
          <p className="step__text">
            <strong>Import</strong> the backup file
          </p>
        </div>
        <div className="step__arrow" aria-hidden="true">
          →
        ...
        <div className="step">
          ...
          <p className="step__text">
            Connect <strong>Destination</strong> → <strong>Restore</strong>
          </p>
        </div>
      </section>
      ...
      {source && (
        <>
          ...
          <section
            className="section-playlists"
            aria-label="Source account playlists"
          >
      ...
      {showRestorePanel && (
        <section
          className="section-restore"
          aria-label="Restore to destination"
        >
          <RestorePanel />
        </section>
      )}
